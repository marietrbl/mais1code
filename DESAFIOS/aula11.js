...
const resultado03 = listPoisicaoCorredores.findIndex(corredor => corredor.nome === 'Dolores') +1
...
const resultado04 = motoboys.filter(motoboy => motoboy.disponivel === true)
...
const resultado05 = missa.filter(pessoa => pessoa.funcao === "Padre")
